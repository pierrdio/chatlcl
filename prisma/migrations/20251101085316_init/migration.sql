...
-- CreateIndex
CREATE INDEX "ReadMessage_messageId_idx" ON "ReadMessage"("messageId");

-- CreateIndex
CREATE INDEX "ReadMessage_userId_idx" ON "ReadMessage"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "ReadMessage_messageId_userId_key" ON "ReadMessage"("messageId", "userId");
